  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Accueil</a></span> <span>Liste de souhaits</span></p>
        <h1 class="mb-0 bread">Ma liste de souhaits</h1>
      </div>
    </div>
  </div>
</div>
            ...
            <tbody>
              <tr class="text-center">
                ...
                <td class="product-name">
                  <h3>Poivron</h3>
                  <p>Très loin, derrière les montagnes, loin des pays...</p>
                </td>
                <td class="price">49,00 DH</td>
                <td class="quantity">
                  <div class="input-group mb-3">
                    <input type="text" name="quantity" class="quantity form-control input-number" value="1" min="1" max="100">
                  </div>
                </td>
                <td class="total">49,00 DH</td>
              </tr>
              ...
              <tr class="text-center">
                ...
                <td class="price">157,00 DH</td>
                <td class="quantity">
                  <div class="input-group mb-3">
                    <input type="text" name="quantity" class="quantity form-control input-number" value="1" min="1" max="100">
                  </div>
                </td>
                <td class="total">157,00 DH</td>
              </tr>
